/*! For license information please see tesseract.min.js.LICENSE.txt */ ! function(t, r) {
	...
	var t = {
						...
						for (;;) switch (t.prev = t.next) {
							case 0:
								return r = at.length > 0 && void 0 !== at[0] ? at[0] : "eng", e = at.length > 1 && void 0 !== at[1] ? at[1] : m.LSTM_ONLY, n = at.length > 2 && void 0 !== at[2] ? at[2] : {}, c = at.length > 3 && void 0 !== at[3] ? at[3] : {}, f = g("Worker", j), s = p(u(u({}, w), n)), b = s.logger, P = s.errorHandler, k = l(s, o), _ = {}, T = {}, N = "string" == typeof r ? r.split("+") : r, A = e, I = c, G = [m.DEFAULT, m.LSTM_ONLY].includes(e) && !k.legacyCore, D = new Promise((function(t, r) {
									...
									if (G && [m.TESSERACT_ONLY, m.TESSERACT_LSTM_COMBINED].includes(r)) throw Error("Legacy model requested but code missing.");
									var o = r || A;
									A = o;
									var i = e || I;
									I = i;
			...
			854: (t, r, e) => {
				...
				t.exports = i(i({}, u), {}, {
					// правка пути к файлу
					workerPath: "worker.5.1.0.min.js"
				})
			},
			581: (t, r, e) => {
				var n = e(854),
