(function(require, requireNative, loadScript, exports, console, privates, apiBridge, bindingUtil, getInternalApi, $Array, $Function, $JSON, $Map, $Math, $Object, $RegExp, $Set, $String, $Error, $Promise) {'use strict';// Copyright 2015 The Chromium Authors. All rights reserved.
