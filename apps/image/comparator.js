...
function Comparator (cfg) {
	...
	document.addEventListener('mouseout', function (e) {
		self.mouseout.call(self, e);
	});
	document.addEventListener('mouseenter', function (e) {
		self.mouseenter.call(self, e);
	});
};
...
Comparator.prototype.reset = function (zoom) {
	var newZoom = 1;
	...
	if (
		...
		var wFit = this.width / this.A.width;
		var hFit = this.height / this.A.height;
		var minFit = Math.min(wFit, hFit);
...
Comparator.prototype.mouseout = function (e) {
	this.mouseIsOut = true;
	this.draw();
};
Comparator.prototype.mouseenter = function (e) {
	this.mouseIsOut = false;
	this.draw();
};
